...
pub(crate) mod raw {
    ...
    extern "C" {
        ...
        pub fn pane_feed(pane: i32, data_ptr: i32, data_len: i32) -> i32;
        pub fn send_keys_from(
            pane: i32, keys_ptr: i32, keys_len: i32, literal: i32, client: i64,
        ) -> i32;
        pub fn send_keys(
        ...
        pub fn fs_read_lines(
            path_ptr: i32, path_len: i32, offset: i64,
            needles_ptr: i32, needles_len: i32, head: i32, max_line: i32,
            out_ptr: i32, out_cap: i32,
        ) -> i64;
        pub fn transcript_extract(
            path_ptr: i32, path_len: i32, offset: i64,
            harness_ptr: i32, harness_len: i32,
        ) -> i64;
        pub fn fs_list(
...
pub(crate) mod raw {
    ...
    pub unsafe fn send_keys_from(pane: i32, keys_ptr: i32, keys_len: i32, literal: i32, client: i64) -> i32 { -7 }
    pub unsafe fn pane_feed(pane: i32, data_ptr: i32, data_len: i32) -> i32 { -7 }
    ...
    pub unsafe fn fs_read_lines(path_ptr: i32, path_len: i32, offset: i64, needles_ptr: i32, needles_len: i32, head: i32, max_line: i32, out_ptr: i32, out_cap: i32) -> i64 { -7 }
    pub unsafe fn transcript_extract(path_ptr: i32, path_len: i32, offset: i64, harness_ptr: i32, harness_len: i32) -> i64 { -7 }
